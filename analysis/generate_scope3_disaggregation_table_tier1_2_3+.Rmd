...
log_step(sprintf("Wrote Parquet: %s", parquet_filename))
log_step(sprintf("Wrote Parquet: %s", parquet_sc_filename))
...
log_step(sprintf("Wrote hierarchical JSON: %s", json_filename))
log_step(sprintf("Wrote JSON: %s", json_sc_filename))
...
log_step(sprintf("Wrote JSON-LD: %s", jsonld_filename))
log_step(sprintf("Wrote JSON-LD: %s", jsonld_sc_filename))
