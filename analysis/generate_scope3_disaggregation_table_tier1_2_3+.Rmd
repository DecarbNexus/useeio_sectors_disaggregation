...
if (export_jsonld) {
  ...
  # Structure: commodity → tier → ghg_source (aggregated across sectors and scopes)
  log_step("Building lightweight JSON-LD (commodity > tier > ghg_source)...")
  ...
  # Lightweight version vocabulary (aggregated, no sector/scope split)
