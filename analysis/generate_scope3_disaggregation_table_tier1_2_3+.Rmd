...
parquet_filename <- file.path(outputs_dir, paste0(file_basename, ".parquet"))
arrow::write_parquet(
...
json_filename <- file.path(outputs_dir, paste0(file_basename, ".json"))
jsonlite::write_json(
  nested_json,
  json_filename,
  pretty = TRUE,
...
jsonld_filename <- file.path(outputs_dir, paste0(file_basename, ".jsonld"))
jsonlite::write_json(
  jsonld_output,
  jsonld_filename,
  pretty = TRUE,
...
cat(" - Parquet:", parquet_filename, "\n")
cat(" - JSON:   ", json_filename, "\n")
cat(" - JSON-LD:", jsonld_filename, "\n")
```
